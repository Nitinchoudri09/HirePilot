...
class BuilderPayment(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='builder_payments')
    plan = models.CharField(max_length=20, choices=UserSubscription.PLAN_CHOICES)
